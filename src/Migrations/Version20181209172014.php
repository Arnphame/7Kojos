 ...
 */
final class Version20181209172014 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product CHANGE quantity quantity INT DEFAULT NULL, CHANGE type type VARCHAR(255) NOT NULL, CHANGE last_edit_date last_edit_date DATE DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product CHANGE quantity quantity INT NOT NULL, CHANGE last_edit_date last_edit_date DATE NOT NULL, CHANGE type type VARCHAR(32) NOT NULL COLLATE utf8mb4_unicode_ci');
    }
}
